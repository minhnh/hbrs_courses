...
%   COMMON INFO
%-------------------------------------------------
\newcommand{\hmwkTitle}{Assessment \upperRomannumeral{3} - Function Minimization}
\newcommand{\hmwkDueDate}{Thursday, 1 June 2017}
...
\section{Hyper parameters}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}{.8\textwidth}
            ...
            \captionof{figure}{median fitness of 20 runs over 1000 generations - frosen 2D}
            \label{fig:boxplot}
        \end{minipage}%
        \linebreak
        \begin{minipage}{.8\textwidth}
            ...
            \captionof{figure}{median fitness of 20 runs over 1000 generations - frosen 12D}
            \label{fig:median}
        \end{minipage}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}{.8\textwidth}
            ...
            \captionof{figure}{median fitness of 20 runs over 1000 generations - frastrigin 2D}
            \label{fig:boxplot}
        \end{minipage}%
        \linebreak
        \begin{minipage}{.8\textwidth}
            ...
            \captionof{figure}{median fitness of 20 runs over 1000 generations - frastrigin 12D}
            \label{fig:median}
        \end{minipage}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}{.8\textwidth}
            \centering
            \includegraphics[width=.95\linewidth]{t3-funcMin-box-frosen2D}
            \captionof{figure}{Box plot for the distribution of fitness of the best children over 20 runs - frosen 2D}
            \label{fig:boxplot}
        \end{minipage}%
        \linebreak
        \begin{minipage}{.8\textwidth}
            \centering
            \includegraphics[width=.95\linewidth]{t3-funcMin-box-frosen12D}
            \captionof{figure}{Median fitness progression over 60 generations of 20 runs - frosen 12D}
            \label{fig:median}
        \end{minipage}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}{.8\textwidth}
            \centering
            \includegraphics[width=.95\linewidth]{t3-funcMin-box-frastrigin2D}
            \captionof{figure}{Box plot for the distribution of fitness of the best children over 20 runs - frastrigin 2D}
            \label{fig:boxplot}
        \end{minipage}%
        \linebreak
        \begin{minipage}{.8\textwidth}
            \centering
            \includegraphics[width=.95\linewidth]{t3-funcMin-box-frastrigin12D}
            \captionof{figure}{Median fitness progression over 60 generations of 20 runs - frastrigin 12D}
            \label{fig:median}
        \end{minipage}
    \end{figure}
