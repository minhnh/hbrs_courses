...
\section{Hyper parameters}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}{\textwidth}
            \centering
            \includegraphics[width=.95\linewidth]{t3-funcMin-fitnessandbox-frosen2d}
            \captionof{figure}{median fitness and distribution of best children over 20 runs of 150 generations - frosen 2D}
            \label{fig:frosen2d}
        \end{minipage}%
    \end{figure}
    ...
    \begin{minipage}{\textwidth}
        \centering
        \includegraphics[width=.95\linewidth]{t3-funcMin-fitnessandbox-frosen12d}
        \captionof{figure}{median fitness and distribution of best children over 20 runs of 150 generations - frosen 12D}
        \label{fig:frosen12d}
    \end{minipage}%
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}{\textwidth}
            ...
            \captionof{figure}{median fitness and distribution of best children over 20 runs of 150 generations - frastrigin 2D}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}{\textwidth}
            ...
            \captionof{figure}{Box plot for the distribution of fitness of the best children over 20 runs - frastrigin 12D}
