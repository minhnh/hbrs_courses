...
%   COMMON INFO
%-------------------------------------------------
\newcommand{\hmwkTitle}{Assessment \upperRomannumeral{1} - Knapsack}
...
\begin{document}
    ...
    \begin{tabular}{lp{5cm}}
        Total Value & 595 \\
        Total Weight & 369 \\
        Items & map, water, banana, cheese, camera, trousers, umbrella, waterproof trousers, waterproof overclothes, note-case, towel\\
    \end{tabular}


    \section{Fitness of each iteration}

    The following plot shows the maximum fitness (out of 50 runs) each generation with mutation rates 0.04.

    \includegraphics[width=\linewidth]{t1-knapsack-mutation_fitness}
