...
The grasp pipeline will also be tested on the \footnoteHref{https://www.care-o-bot.de/en/care-o-bot-3.html}{
Care-o-bot 3}, the other robot platform available to the project. Nearest neighbor algorithms can also be used to
