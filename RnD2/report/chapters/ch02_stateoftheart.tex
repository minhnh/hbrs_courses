...
to generate the \footnoteHref{http://grasping.cs.columbia.edu}{Columbia Grasp Database}. Grasp planning is then done by
...
Table \ref{table:grasp_quality_approaches} lists recent prominent empirical approaches to predicting grasp quality.
...
single depth image \cite{Yang2017}, which in turn can be used for \todo{for what}
