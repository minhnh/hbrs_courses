...
\subsection*{Pose estimation for detected objects}
...
using the \footnoteHref{https://www.boost.org/doc/libs/1\_68\_0/libs/python/}{Boost Python} library. The grasping
...
\picHereWidth{grasp_gqcnn_result}{An example grasp pose returned from the GQCNN grasp planner.}
